...
function Projects() {
  ...
  const handleMouseMove = (e, cardRef) => {
    ...
    card.style.transform = `rotateX(${rotateX}deg) rotateY(${rotateY}deg) scale(1.1) rotateZ(${rotateY / 5}deg)`;
  };

  const handleMouseLeave = (cardRef) => {
    const card = cardRef.current;
    if (!card) return;
    card.style.transform = "rotateX(0) rotateY(0) scale(1) rotateZ(0)";
  };
          ...
          return (
            <article
              ...
              className="group relative rounded-2xl border border-gray-200 bg-white shadow-md p-6 
                         ...
                         hover:shadow-3xl hover:border-transparent 
            ...
            >
              ...
              <div className="flex items-center gap-3 mb-4">
                <div className="p-3 rounded-full bg-gray-100 shadow-md group-hover:scale-110 transition-transform duration-300">
                  {p.icon}
                </div>
              ...
              <div
                className="absolute inset-0 rounded-2xl opacity-0 group-hover:opacity-100 transition duration-500 blur-lg -z-10 
                           bg-gradient-to-br from-blue-100 via-purple-200 to-pink-100 hover-gradient-animate"
              ></div>
            </article>
          );
        })}
