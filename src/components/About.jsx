...
import aboutBg from "../about me.jpg";
      ...
      <div className="relative z-10 px-6 max-w-5xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="md:col-span-2">
            ...
            {/* Education Card */}
            <div className="mt-6 rounded-xl border border-white/20 bg-white/90 backdrop-blur-sm p-6 shadow-sm hover:shadow-2xl hover:scale-105 transition-all duration-300 hover:bg-white">
            ...
            <div className="mt-6 grid sm:grid-cols-2 gap-4">
              <div className="rounded-xl border border-white/20 bg-white/90 backdrop-blur-sm p-6 shadow-sm hover:shadow-2xl hover:scale-105 hover:bg-white transition-all duration-300">
          ...
          <aside className="md:col-span-1">
            <div className="rounded-2xl border border-white/20 bg-white/90 backdrop-blur-sm p-6 shadow-sm hover:shadow-2xl hover:scale-105 hover:bg-white transition-all duration-300">
